            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form role="form" class="text-start" method="post" action="{{ route('auth.login') }}">
                    @csrf
                  <div class="input-group input-group-static @error('username') is-invalid @enderror my-3">
                  ...
                  <div class="input-group input-group-static mb-3 @error('password') is-invalid @enderror">
